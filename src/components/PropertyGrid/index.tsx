...
function PropertyGrid(property: Property) {
  ...
  return (
    <div
      ...
      className="max-w-sm bg-white rounded-lg shadow-md overflow-hidden transition-shadow duration-300 hover:scale-[1.02] hover:shadow-2xl relative pb-16"
    >
